...
This document describes version 0.10 of SHARYANTO::SQL::Schema (from Perl distribution SHARYANTO-SQL-Schema), released on 2014-09-06.
...
Please visit the project's homepage at L<https://metacpan.org/release/SHARYANTO-SQL-Schema>.

=head1 SOURCE

Source repository is at L<https://github.com/sharyanto/perl-SHARYANTO-SQL-Schema>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=SHARYANTO-SQL-Schema>
